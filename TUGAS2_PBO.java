...
public class TUGAS2_HandikaVrendy {

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Scanner sc = new Scanner(System.in);
        Integer pilihan = 0;
        int harga_item[] = {17000, 21000, 25000, 27000};
        String menu = null;
        int pembayaran;
        ...
        System.out.println("| 2. Arabika                  |   Rp 21000      |");
        System.out.println("| 3. Latte                    |   Rp 25000      |");
        System.out.println("| 4. Matcha                   |   Rp 27000      |");
